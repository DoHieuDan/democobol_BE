package fa.training.accessor;


import fa.training.lib.constants.ValueConst;
import fa.training.lib.util.FieldFormat;
import fa.training.lib.util.ValueUtil;
import fa.training.model.WsDateTime;
...
public class WsDateTime_Accessor {
  ...
  public static String getWsCurdateN(WsDateTime wsDateTime){
  ...
  public static String getWsCurtimeN(WsDateTime wsDateTime){
      return WsDateTime_Accessor.getWsDateTime(wsDateTime);
  }
